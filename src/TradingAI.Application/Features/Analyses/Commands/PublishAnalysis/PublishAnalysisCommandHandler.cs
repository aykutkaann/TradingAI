...
{
    public class PublishAnalysisCommandHandler(IApplicationDbContext db) :IRequestHandler<PublishAnalysisCommand, Unit>
    {
        public async Task<Unit> Handle(PublishAnalysisCommand request, CancellationToken ct)
        {
